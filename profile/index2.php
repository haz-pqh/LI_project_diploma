...
<body class="index-page">
  ...
  <header id="header" class="header dark-background d-flex flex-column">
    ...
    <div class="profile-img">
      <img src="../assets/img/staff/2.png" alt="" class="img-fluid rounded-circle" style="background-color: rgba(255, 255, 255, 0.663);">
    </div>
        ...
        <ul>
          ...
          <li class="dropdown"><a href="#"><span>Manangements</span> <i class="bi bi-chevron-down toggle-dropdown"></i></a>
            <ul>
              ...
              <li><a href="../profile/index2.php?username=2" class="active">Deputy Dean</a></li>
          ...
          <li><a href="../update_profile/login_page.php?id=2">Update Profile</a></li>
          <br>
          <br>
  ...
  <main class="main">
    ...
    <section id="" class="hero section dark-background">
      ...
      <img src="assets/img/virtual_assistant-e1685370582522.jpg" alt="" data-aos="fade-in" class="" style="opacity: 0.5;">
    ...
    <section id="about" class="about section">
      ...
      <div class="container section-title" data-aos="fade-up">
        <h2>Profile</h2>
        <p>Strong academic and technical knowledge across Information Technology, Operating System, Database, Video-Based Learning, Learning Engagement, Motivation, Social Media, and Digital Business. Recognized as a passionate educator with more than 15 years of teaching experience.</p>
      ...
      <div class="container" data-aos="fade-up" data-aos-delay="100">
        ...
        <div class="row gy-4 justify-content-center">
          <div class="col-lg-4">
            <img src="assets/img/DEPUTY_DEAN.jpg" class="img-fluid" alt="">
          </div>
