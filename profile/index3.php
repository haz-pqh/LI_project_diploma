...
<body class="index-page">
  ...
  <header id="header" class="header dark-background d-flex flex-column">
    ...
    <div class="profile-img">
      <img src="../assets/img/staff/45.png" alt="" class="img-fluid rounded-circle" style="background-color: rgba(255, 255, 255, 0.663);">
    </div>
        ...
        <ul>
          ...
          <li class="dropdown"><a href="#"><span>Manangements</span> <i class="bi bi-chevron-down toggle-dropdown"></i></a>
            <ul>
              ...
              <li><a href="../profile/index3.php?username=45" class="active">Executive Officer</a></li>
          ...
          <li><a href="../update_profile/login_page.php?id=45">Update Profile</a></li>
          <br>
          <br>
  ...
  <main class="main">
    ...
    <section id="" class="hero section dark-background">
      ...
      <img src="assets/img/wall4.jpg" alt="" data-aos="fade-in" class="">
    ...
    <section id="about" class="about section">
      ...
      <div class="container section-title" data-aos="fade-up">
        <h2>Profile</h2>
        <p style="text-align: justify;">Khairul Azhar bin Khalid currently served as a junior executive at Faculty of Computing & Multimedia (FCOM), University Poly-Tech Malaysia (UPTM). He was an alumnus of UPTM (previously known as Kolej Poly-Tech MARA (KPTM) Kuala Lumpur) where he graduated with B.A. (Hons) in Business Information Technology with International Business from the institution in 2008 before pursuing his Master's level and graduated with MSc in Business Decision Management from Coventry University, United Kingdom in 2010.
          <br>
          <br>
          He started his service at UPTM in 2010 as an information technology lecturer after completed his studies and has been in service for 14 years (to date) as he has been involved with teaching and management role for the faculty. His specialization area is in Decision Support System (DSS) in IT field as he really had a passionate on how decision is made with the assistance of technology.
          <br>
          <br>
          He also partially involved with research grants focusing on lean management and IT sustainability with his research grant's team.</p>
      ...
      <div class="container" data-aos="fade-up" data-aos-delay="100">
        ...
        <div class="row gy-4 justify-content-center">
          <div class="col-lg-4">
            <img src="assets/img/azhar.jpeg" class="img-fluid" alt="">
          </div>
