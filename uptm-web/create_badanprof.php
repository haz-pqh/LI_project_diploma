...
<div class="container my-5">
    ...
    <form action="badanprof_save.php" method="post">
        <div class="row mb-3">
            ...
            <div class="col-sm-6">
                <input type="text" class="form-control" name="badan_name" value="">
            </div>
        </div>
        <br>
        <div class="row mb-3">
            ...
            <div class="col-sm-6">
                <input type="text" class="form-control" name="badan_period" value="">
            </div>
        </div>
        <br>
        <div class="row mb-3">
            ...
            <div class="col-sm-6">
                <input type="text" class="form-control" name="badan_type" value="">
            </div>
        </div>
        <br>
        <div class="row mb-3">
            ...
            <div class="col-sm-6">
                <input type="text" class="form-control" name="peranan_badan" value="">
            </div>
        </div>
        ...
        <div class="row mb-3">
            <div class="offset-sm-3 col-sm-3 d-grid">
                <button type="submit" name="save_badanprof" class="btn btn-primary">Submit</button>
            </div>
            <div>
