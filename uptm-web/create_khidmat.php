...
<div class="container my-5">
    ...
    <form action="khidmat_save.php" method="post">
        <div class="row mb-3">
            ...
            <div class="col-sm-6">
                <input type="text" class="form-control" name="jenis_aktiviti" value="">
            </div>
        </div>
        <br>
        <div class="row mb-3">
            ...
            <div class="col-sm-6">
                <input type="text" class="form-control" name="tarikh_aktiviti" value="">
            </div>
        </div>
        <br>
        <div class="row mb-3">
            ...
            <div class="col-sm-6">
                <input type="text" class="form-control" name="penganjur_aktiviti" value="">
            </div>
        </div>
        <br>
        <div class="row mb-3">
            ...
            <div class="col-sm-6">
                <input type="text" class="form-control" name="peranan_aktiviti" value="">
            </div>
        </div>
        ...
        <div class="row mb-3">
            <div class="offset-sm-3 col-sm-3 d-grid">
                <button type="submit" name="save_khidmat" class="btn btn-primary">Submit</button>
            </div>
            <div>
